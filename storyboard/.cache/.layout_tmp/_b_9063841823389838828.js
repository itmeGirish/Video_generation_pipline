const NARRATION_TEXT = "Theo Browne \u2014 and I quote \u2014 'GPT-5.5 is smart, weird, hard to wrangle, and too expensive.' <pause 0.2s> CodeRabbit's production tests: issue detection jumped from fifty-eight to seventy-nine percent \u2014 but only with extremely specific prompts. <pause 0.2s> GPT-5.5? Brilliant intern. <pause 0.2s> Claude? Senior engineer.";
const quotes=[
