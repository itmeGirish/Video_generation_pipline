...
const __mainEl = _scnCard({ borderColor: D.cyan, fadeIn,
  children: [
    _scnTitle('ANTHROPIC — THE CONSULTANT', D.cyan, Math.round(width * 0.030)),
    _scnRow([
      _scnPill('36% hallucination', D.cyan),
      _scnPill('Self-verification', D.cyan),
      _scnPill('Mythos restricted', D.cyan),
    ]),
    _scnSubtitle('Competing with McKinsey.', D.text_dim),
  ]
});
