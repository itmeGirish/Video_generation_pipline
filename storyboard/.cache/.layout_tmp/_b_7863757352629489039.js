...
return React.createElement('div', {
  style:{ position:'absolute', inset:0, opacity: fadeIn,
          display:'flex', alignItems:'center', justifyContent:'center', gap: 24, padding: 48 }
},
  _scnPill('OS / SUPER-APP → BET OPENAI', D.violet),
  _scnPill('PRECISION TOOL → BET ANTHROPIC', D.cyan),
  _scnPill('BOTH → USE ROUTING LAYER', D.amber)
);
