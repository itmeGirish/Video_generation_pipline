...
const __mainEl = React.createElement('div', {
  ...
  React.createElement('div', {
    style:{ width: panelW, height: panelH, backgroundColor: D.surface,
            border: '3px solid ' + D.violet, borderRadius: 16, padding: 36,
            display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap: 12 }
  },
    _scnTitle('ACT', D.violet, Math.round(width * 0.060)),
    _scnSubtitle('BENCHMARK SCORES', D.text_dim)
  ),
  React.createElement('div', {
    style:{ width: panelW, height: panelH, backgroundColor: D.surface,
            border: '3px solid ' + D.cyan, borderRadius: 16, padding: 36,
            display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap: 12 }
  },
    _scnTitle('REASON', D.cyan, Math.round(width * 0.060)),
    _scnSubtitle('BENCHMARK SCORES', D.text_dim)
  )
);
