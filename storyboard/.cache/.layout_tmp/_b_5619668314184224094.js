...
return _scnCard({ borderColor: D.violet, fadeIn,
  width: Math.round(width * 0.60), height: Math.round(height * 0.32),
  top: Math.round(height * 0.34),
  children: [
    _scnTitle('→ GPT-5.5', D.violet, Math.round(width * 0.040)),
    _scnSubtitle('fast · cheap · broad tool use', D.text)
  ]
});
