...
return _scnCard({ borderColor: D.amber, fadeIn,
  children: [
    _scnTitle('IF ACCURACY MATTERS:', D.cyan),
    _scnRow([
      _scnPill('legal brief', D.cyan), _scnPill('production code', D.cyan),
      _scnPill('medical advice', D.cyan), _scnPill('financial analysis', D.cyan),
    ]),
    _scnTitle('IF IT DOESN’T:', D.violet),
    _scnRow([
      _scnPill('brainstorm', D.violet), _scnPill('first draft', D.violet),
      _scnPill('ideation', D.violet), _scnPill('throwaway agent', D.violet),
    ])
  ]
});
