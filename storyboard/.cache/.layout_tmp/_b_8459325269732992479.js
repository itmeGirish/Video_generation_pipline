...
const stampFS = Math.round(width * 0.011);  // smaller stamp so it doesn't overlap the total numbers
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          style:{
            ...
            padding: '2px 6px', letterSpacing: 1.5, backgroundColor: 'transparent',
            pointerEvents: 'none'
          }
        }, stampText)
      )
