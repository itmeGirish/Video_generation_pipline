...
const __mainEl = React.createElement('div', {
  ...
  React.createElement('div', { style:{ fontFamily: D.font_display, fontWeight: 900,
                                        fontSize: Math.round(width * 0.16), color: D.red,
                                        textShadow: '0 0 40px ' + D.red, opacity: fadeIn } }, '86%'),
  React.createElement('div', { style:{ fontFamily: D.font_display, fontWeight: 700,
                                        fontSize: Math.round(width * 0.020), color: D.amber,
                                        letterSpacing: 4, opacity: fadeIn } },
    'smarter ≠ more honest'),
  React.createElement('div', {
    style:{ position:'absolute', inset: 0, backgroundColor: D.bg, opacity: hardCutOp }
  })
);
