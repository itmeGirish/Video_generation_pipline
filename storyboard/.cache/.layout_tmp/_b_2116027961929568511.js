...
const __mainEl = _scnCard({ borderColor: D.red, fadeIn,
  children: [
    _scnTitle('WHEN STUMPED, GPT-5.5 INVENTS:', D.text_dim, Math.round(width * 0.020)),
    React.createElement('div', {
      style:{ fontFamily: D.font_display, fontWeight: 900,
              fontSize: Math.round(width * 0.18), color: D.red,
              textAlign: 'center', textShadow: '0 0 40px ' + D.red }
    }, '86%'),
    _scnSubtitle('86% of the time it is stumped — not 86% of all answers.', D.text)
  ]
});
