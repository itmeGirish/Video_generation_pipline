...
return _scnCard({ borderColor: D.cyan, fadeIn,
  children: [
    _scnTitle('CLAUDE ALONE — NO PIPELINE', D.cyan, Math.round(width * 0.024)),
    _scnLine('TOKENS: 3,000', D.cyan, Math.round(width * 0.022), 900),
    _scnLine('COST:   $0.95', D.red, Math.round(width * 0.022), 900),
    _scnLine('TIME:   20s', D.cyan, Math.round(width * 0.022), 900),
    _scnSubtitle('Same accuracy. Four times the cost.', D.text_dim),
  ]
});
