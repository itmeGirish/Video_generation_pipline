...
const __mainEl = React.createElement('div', {
  ...
  React.createElement('div', { style:{ fontFamily: D.font_display, fontWeight: 900,
                                        fontSize: Math.round(width * 0.044), color: D.cyan,
                                        letterSpacing: 4 } }, 'PICK BY TASK'),
  React.createElement('div', { style:{ fontFamily: D.font_display, fontWeight: 900,
                                        fontSize: Math.round(width * 0.044), color: D.violet,
                                        letterSpacing: 4 } }, 'BUILD THE ROUTING LAYER')
);
