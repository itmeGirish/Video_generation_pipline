...
const __mainEl = React.createElement('div', {
  style:{ position:'absolute', left: '5%', top: '40%', width: '90%', height: '20%',
          backgroundColor: D.surface_hi, border: '3px solid ' + D.amber, borderRadius: 12,
          display:'flex', alignItems:'center', justifyContent:'center',
          opacity: fadeIn,
          fontFamily: D.font_display, fontWeight: 900, fontSize: Math.round(width * 0.044),
          color: D.amber, letterSpacing: 4 }
}, 'NOT COMPETITORS. SPECIALISTS.');
