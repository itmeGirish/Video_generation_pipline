const NARRATION_TEXT = "If you're using AI for anything that matters \u2014 code, research, client work \u2014 I need you to hear two facts about the same model. <pause 0.3s> Fact one.";
