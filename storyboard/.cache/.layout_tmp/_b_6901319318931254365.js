...
const __mainEl = _scnCard({ borderColor: D.red, fadeIn,
  children: [
    _scnTitle('CLAUDE TO CUSTOMER:', D.text, Math.round(width * 0.024)),
    _scnLine('"Refund processed! ✓"', D.green, Math.round(width * 0.024), 900),
    React.createElement('div', { style:{
      padding: '8px 16px', border: '3px solid ' + D.red, color: D.red,
      fontFamily: D.font_display, fontWeight: 900, fontSize: Math.round(width * 0.030),
      letterSpacing: 4, transform: 'rotate(-8deg)', alignSelf: 'flex-start'
    }}, 'NEVER SENT'),
    _scnSubtitle('Claude pocketed $3.50.', D.text_dim)
  ]
});
