...
const leftLeaf = React.createElement('div', {style:{
  ...
  React.createElement('div', {style:{color:D.green, fontFamily:D.font_display, fontWeight:'700', fontSize:Math.round(w*0.016)}}, 'YES → LOW')
);
...
const centerLeaf = React.createElement('div', {style:{
  ...
  React.createElement('div', {style:{color:D.amber, fontFamily:D.font_display, fontWeight:'700', fontSize:Math.round(w*0.016)}}, 'YES → MEDIUM')
);
...
const rightLeaf = React.createElement('div', {style:{
  ...
  React.createElement('div', {style:{color:D.red, fontFamily:D.font_display, fontWeight:'700', fontSize:Math.round(w*0.016)}}, 'YES → HIGH / MAX')
);
