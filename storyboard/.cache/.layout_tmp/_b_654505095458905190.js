...
return _scnCard({ borderColor: D.violet, fadeIn,
  ...
  children: [
    _scnTitle('GPT-5.5 DRAFT', D.violet),
    _scnLine('TOKENS: 1,200', D.violet, Math.round(width * 0.024), 900),
    _scnLine('COST:   $0.06', D.violet, Math.round(width * 0.024), 900),
    _scnLine('TIME:   3s', D.violet, Math.round(width * 0.024), 900),
    _scnSubtitle('+ 2 potential hallucinations flagged', D.red)
  ]
});
