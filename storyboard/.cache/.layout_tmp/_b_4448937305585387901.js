...
// Split panels — flex row with two siblings, no overlap
...
const __mainEl = React.createElement('div', {
  ...
  React.createElement('div', {
    style:{ width: panelW, height: panelH, backgroundColor: D.surface,
            border: '3px solid ' + D.cyan, borderRadius: 16, padding: 48,
            display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap: 18 }
  }, _scnTitle('CLAUDE OPUS 4.7', D.cyan, Math.round(width * 0.035))),
  React.createElement('div', {
    style:{ width: panelW, height: panelH, backgroundColor: D.surface,
            border: '3px solid ' + D.violet, borderRadius: 16, padding: 48,
            display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap: 18 }
  }, _scnTitle("GPT-5.5 'SPUD'", D.violet, Math.round(width * 0.035)))
);
