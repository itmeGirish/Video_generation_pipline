...
const __mainEl = _scnCard({ borderColor: D.amber, fadeIn,
  children: [
    _scnTitle('USE THIS FOR: customer-facing AI agents', D.amber, Math.round(width * 0.022)),
    _scnLine('DEFEND vs HALLUCINATION: fact-check pipeline, RAG with citations', D.cyan),
    _scnLine('DEFEND vs LYING: action audit logs, verifiable execution traces', D.cyan),
    _scnLine('RULE: Customer-facing agent? You need BOTH defenses.', D.amber),
  ]
});
