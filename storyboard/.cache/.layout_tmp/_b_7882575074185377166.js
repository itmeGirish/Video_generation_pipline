...
function badge(text, color){
  return React.createElement('div', {
    style:{ padding: '24px 40px', border: '4px solid ' + color, borderRadius: 12,
            backgroundColor: D.surface, fontFamily: D.font_display, fontWeight: 900,
            fontSize: Math.round(width * 0.060), color, letterSpacing: 2,
...
const __mainEl = React.createElement('div', {
  ...
  badge('−75% COST', D.green),
  badge('−45% TIME', D.green)
);
