...
const __mainEl = _scnCard({ borderColor: D.amber, fadeIn,
  width: Math.round(width * 0.85), height: Math.round(height * 0.40),
  top: Math.round(height * 0.30),
  children: [
    _scnTitle('SOURCE', D.amber, Math.round(width * 0.022)),
    _scnLine('GPT leads ACT benchmarks by 5–13 pts.', D.cyan),
    _scnLine('Claude leads REASON by 2–6 pts.', D.cyan),
    _scnSubtitle('Artificial Analysis, OpenAI launch page — April 2026', D.text_dim),
  ]
});
