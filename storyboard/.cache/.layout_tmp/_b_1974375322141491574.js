...
const __mainEl = _scnCard({ borderColor: D.amber, fadeIn,
  children: [
    _scnTitle('YOUR ROADMAP:', D.amber, Math.round(width * 0.026)),
    _scnLine('☐  Building an OS / super-app?', D.text),
    _scnLine('☐  Building a precision tool?', D.text),
    _scnLine('☐  Building both?', D.text),
  ]
});
