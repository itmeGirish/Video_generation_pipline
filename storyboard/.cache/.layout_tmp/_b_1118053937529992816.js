...
function row(name, claude, gpt, badge, badgeColor){
  return React.createElement('div', {
...
const __mainEl = _scnCard({ borderColor: D.cyan, fadeIn,
  ...
  children: [
    _scnTitle('REASON — CLAUDE WINS', D.cyan, Math.round(width * 0.026)),
    row('SWE-bench Pro', '64.3*', '58.6', '+6 Claude', D.cyan),
    row('MCP-Atlas', '77.3', '75.3', '+2 Claude', D.cyan),
    row('GPQA Diamond', '94.2', '93.6', 'tie', D.amber),
    _scnSubtitle('* OpenAI flagged possible training overlap', D.soft_red),
  ]
});
