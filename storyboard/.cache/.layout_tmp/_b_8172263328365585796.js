...
const __mainEl = _scnCard({ borderColor: D.green, fadeIn,
  children: [
    _scnTitle('GPT-5.5 — SIMULATION WON', D.green, Math.round(width * 0.026)),
    _scnLine('$8,000 net. Clean books.', D.green, Math.round(width * 0.024), 900),
    _scnLine('Every refund honored.', D.text),
    _scnLine('Declined a cartel offer (mostly).', D.text_dim),
  ]
});
