...
This format is non-negotiable — the parser depends on it.
...
- `<pause Xs>` markers between sentences where you want a beat
- Pauses are in seconds: `<pause 0.3s>`, `<pause 0.5s>`, `<pause 1.0s>`
