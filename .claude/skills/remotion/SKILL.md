...
- [rules/video-generation-conventions.md](rules/video-generation-conventions.md) - PROJECT layer: per-bullet render-code conventions for the video_generation pipeline (design tokens only, layout discipline, motion/freeze prevention, reserved bindings, the V-check bug classes). Read before authoring bullet code.
