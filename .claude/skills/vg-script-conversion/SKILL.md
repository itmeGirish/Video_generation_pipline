...
description: "How any-format .txt script gets auto-converted to canonical structured-script format. REGEX ONLY. Hand-convert via rule 18 if regex fails. Use whenever running script_converter.py, or any request like "convert script," "script converter," "canonical format," "auto-convert," or "regex conversion.""
---
