---
name: vg-script-writing-prompt
description: "Copy-paste prompt for writing a new source script that the pipeline renders with high fidelity. Use when starting a new video from scratch, or any request like "write a new script," "copy-paste prompt," "starting a new video," "script template," or "how to write a source script.""
---
