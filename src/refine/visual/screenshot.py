...
class ScreenshotCapture:
    ...
    DEFAULT_REMOTION_URL = None  # Set from config
    ...
    def __init__(
        ...
        self.fps = fps
        if remotion_url is None:
            from ...config import load_config
            remotion_url = load_config().remotion.dev_url
...
def check_remotion_running(url: str | None = None) -> bool:
    """
    ...
    if url is None:
        from ...config import load_config
        url = load_config().remotion.dev_url
    try:
