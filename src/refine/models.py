...
class IssueType(str, Enum):
    ...
    ENGAGEMENT = "engagement"  # Dead air / low density / monotonous pacing (fix #4)
    OTHER = "other"
...
class SceneRefinementResult:
    ...
    error_message: Optional[str] = None
    # Architectural fix #4 — engagement score (opaque dict so models.py doesn't
    # have to import the scorer module).
